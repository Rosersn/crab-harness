...
from crab.agents.memory.queue import get_memory_queue
from crab.agents.thread_state import AgentRuntimeContext
...
class MemoryMiddleware(AgentMiddleware[MemoryMiddlewareState]):
    ...
    @override
    def after_agent(self, state: MemoryMiddlewareState, runtime: Runtime[AgentRuntimeContext]) -> dict | None:
