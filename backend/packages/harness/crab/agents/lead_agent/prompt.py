...
from crab.config.agents_config import load_agent_soul
...
Crab is an AI agent platform that provides production-ready agent systems
[citation:Project Overview](https://example.com/crab). The project focuses on
providing a production-ready agent system with sandbox execution and memory management
[citation:Crab Documentation](https://example.com/crab/docs).
...
### Primary Sources
- [Project Overview](https://example.com/crab) - Official documentation
- [Crab Documentation](https://example.com/crab/docs) - Technical specifications
...
- ✅ RIGHT in Sources: `[Project Overview](https://example.com/crab) - 官方文档`
...
def _get_memory_context(agent_name: str | None = None) -> str:
    ...
    """
    try:
        from crab.agents.memory import format_memory_for_injection, get_memory_data
...
def get_deferred_tools_prompt_section() -> str:
    ...
    """
    from crab.tools.builtins.tool_search import get_deferred_registry
...
def _build_acp_section() -> str:
    ...
    try:
        from crab.config.acp_config import get_acp_agents
