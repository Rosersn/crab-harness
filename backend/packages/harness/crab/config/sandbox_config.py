...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: crab-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. crab.sandbox.local:LocalSandboxProvider)",
    )
