...
from crab.community.infoquest import tools
from crab.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("crab.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("crab.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("crab.community.infoquest.tools.get_app_config")
