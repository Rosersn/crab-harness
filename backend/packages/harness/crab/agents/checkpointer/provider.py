...
Usage::
    ...
    from crab.agents.checkpointer.provider import get_checkpointer, checkpointer_context
...
from crab.config.checkpointer_config import CheckpointerConfig
from crab.config.paths import resolve_path
...
def get_checkpointer() -> Checkpointer:
    ...
    from crab.config.app_config import _app_config
    from crab.config.checkpointer_config import get_checkpointer_config
