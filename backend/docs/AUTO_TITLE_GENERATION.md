...
{
  "graphs": {
    "lead_agent": "crab.agents:lead_agent"
  },
...
```python
from crab.config.title_config import TitleConfig, set_title_config
...
# 测试 title 生成
import pytest
from crab.agents.title_middleware import TitleMiddleware
...
- [`packages/harness/crab/agents/thread_state.py`](../packages/harness/crab/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/crab/agents/title_middleware.py`](../packages/harness/crab/agents/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/crab/config/title_config.py`](../packages/harness/crab/config/title_config.py) - 配置管理
- [`config.yaml`](../config.yaml) - 配置文件
- [`packages/harness/crab/agents/lead_agent/agent.py`](../packages/harness/crab/agents/lead_agent/agent.py) - Middleware 注册
