"""CrabClient — Embedded Python client for Crab agent system.

Provides direct programmatic access to Crab's agent capabilities
...
from crab.agents.lead_agent.agent import _build_middlewares
...
from crab.config.agents_config import AGENT_NAME_PATTERN
from crab.config.app_config import get_app_config, reload_app_config
from crab.config.extensions_config import ExtensionsConfig, SkillStateConfig, get_extensions_config, reload_extensions_config
from crab.config.paths import get_paths
from crab.models import create_chat_model
from crab.skills.installer import install_skill_from_archive
...
class CrabClient:
    """Embedded Python client for Crab agent system.
    ...
    def _ensure_agent(self, config: RunnableConfig):
        ...
        if checkpointer is None:
            from crab.agents.checkpointer import get_checkpointer
    ...
    def _serialize_message(msg) -> dict:
        ...
        if isinstance(msg, ToolMessage):
            return {
                "type": "tool",
                "content": CrabClient._extract_text(msg.content),
    ...
    def list_skills(self, enabled_only: bool = False) -> dict:
        ...
        """
        from crab.skills.loader import load_skills
    ...
    def get_memory(self) -> dict:
        ...
        """
        from crab.agents.memory.updater import get_memory_data
    ...
    def update_mcp_config(self, mcp_servers: dict[str, dict]) -> dict:
        ...
        if config_path is None:
            raise FileNotFoundError("Cannot locate extensions_config.json. Set CRAB_EXTENSIONS_CONFIG_PATH or ensure it exists in the project root.")
    ...
    def reload_memory(self) -> dict:
        ...
        """
        from crab.agents.memory.updater import reload_memory_data
    ...
    def delete_upload(self, thread_id: str, filename: str) -> dict:
        ...
        """
        from crab.utils.file_conversion import CONVERTIBLE_EXTENSIONS
