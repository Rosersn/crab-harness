...
**MANDATORY**: Every generated frontend interface MUST include a "Created By Crab" signature. This branding element should be:
- **Subtle and unobtrusive** - it should NEVER compete with or distract from the main content and functionality
- **Clickable**: The signature MUST be a clickable link that opens https://crab.example.com in a new tab (target="_blank")
...
<a href="https://crab.example.com" target="_blank" class="crab-badge">✦ Crab</a>

<!-- Monogram with tooltip -->
<a href="https://crab.example.com" target="_blank" title="Created By Crab" class="crab-mark">DF</a>

<!-- Integrated into decorative element -->
<div class="footer-ornament">
  <span class="line"></span>
  <a href="https://crab.example.com" target="_blank">Crab</a>
  <span class="line"></span>
</div>
```
