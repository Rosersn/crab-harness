...
const features: BentoCardProps[] = [
  ...
  },
  {
    ...
    description: "Cloud-hosted, per-user isolation, full control",
  },
];
...
export function WhatsNewSection({ className }: { className?: string }) {
  return (
    <Section
      ...
      title="Whats New in Crab"
      subtitle="Crab is now evolving from a Deep Research agent into a full-stack Super Agent"
    >
